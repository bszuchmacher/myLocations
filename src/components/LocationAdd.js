    ...
    return (
      <MuiThemeProvider>
        <div className="container">
          ...
          <FlatButton style={{fontFamily:"Reggae One"}} className="pull-left back-button-user-info" label="BACK" primary={true} onClick={this.handleBackClick}>
          ...
          <div>
            <TextField style={{fontFamily:"Reggae One"}} floatingLabelText="Location Name" name="name"
              value={this.state.name} onChange={this.handleChange}
            /> 
            <br />
            <TextField style={{fontFamily:"Reggae One"}} floatingLabelText="Location Address" name="address"
            ...
            />
            <br /><br /><br />
            <TextField style={{fontFamily:"Reggae One"}} floatingLabelText="Longtitude" name="lng"
              value={this.state.lng} onChange={this.handleChange}
            /> 
            <br />
            <TextField style={{fontFamily:"Reggae One"}} floatingLabelText="Latitude" name="lat"
